<template>
  <section class="text-gray-600 body-font">
    <div class="container relative z-10 px-5 py-24 mx-auto">
      ...
      <div
        class="relative z-10 flex flex-wrap -mx-4 -mt-4 -mb-10 space-y-6 sm:-m-4 md:space-y-0"
      >
        <div
          class="flex flex-col items-center p-4 text-center transition duration-500 transform md:w-1/4 hover:scale-105 hover:bg-cornsilk-500 hover:bg-opacity-40"
        >
          <div
          ...
          <div class="flex-grow">
            ...
            <a
              href="/seeker"
              class="inline-flex items-center mt-3 transition duration-150 transform hover:scale-110 text-liverdogs-500 hover:text-liverdogs-50"
              >Ir al buscador
              <svg
                fill="none"
                stroke="currentColor"
        ...
        >
          ...
          <div class="flex-grow">
            ...
            <p class="text-base leading-relaxed">
              ...
              Todos llenos de encantos y pecurialidades que han sido descubierto
        ...
        >
          ...
          <div class="flex-grow">
            ...
            <p class="text-base leading-relaxed">
              Navegue por el mapa interactivo de Galisites!, descubriendo
              lugares que no se esperaba o buscando algún sitio con encanto
              cerca de donde está.
            </p>
            <a
              class="inline-flex items-center mt-3 transition duration-150 transform text-liverdogs-500 hover:text-liverdogs-50 hover:scale-110"
...
export default {
  ...
  mounted() {
    if (
      ...
      localStorage.getItem("showNotify") != 0
    ) {
      this.onClickSuccess();
